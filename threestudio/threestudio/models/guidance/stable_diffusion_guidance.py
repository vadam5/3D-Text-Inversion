...
class StableDiffusionGuidance(BaseObject):
    ...
    def configure(self) -> None:
        ...
        self.pipe.load_textual_inversion("/home/ubuntu/3d_text_inversion/diffusers/examples/textual_inversion/textual_inversion_robot_3")
        self.pipe.load_textual_inversion("/home/ubuntu/3d_text_inversion/diffusers/examples/textual_inversion/textual_inversion_lego_harry_potter_explicit_prompts_2")
        self.pipe.load_textual_inversion("/home/ubuntu/3d_text_inversion/diffusers/examples/textual_inversion/textual_inversion_octopus_2")
    ...
    def compute_grad_sds(
        ...
        grad = w.to(noise_pred.device) * (noise_pred - noise)
